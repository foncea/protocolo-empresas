import numpy as np
import pandas as pd
from individuo_seir import Individuo, IndividuoRol, IndividuoFamilia
...
class SimuladorBase:
    def __init__(self, tamano_poblacion, precision_tests, probabilidad, duracion_infeccion, R0):
        ...
        self.p_contagio_diaria = len(self.historia_infectados_totales) / self.tamano_poblacion * self.beta
    ...
    def actualizar_probabilidad(self): 
        ...
        self.p_contagio_diaria = self.beta * len(infecciosos) / self.tamano_poblacion
